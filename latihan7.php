...
//Menggunakan Built in Function PHP tentang Fungsi Date() date(); //fungsi date() memerlukan minimal 1 parameter atau nilai yang dimasukan dalam tanda kurung fungsinya
