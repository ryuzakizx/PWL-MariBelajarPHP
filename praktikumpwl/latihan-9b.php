...
<?php
 ...
 //Cara Menampilkan isi data tipe array biasa
 //echo $huruf; //dianggap salah karena echo tidak bisa mencetak Array tapi mencetak elemen Araay, maka penulisan yang  benar seperti berikut
 echo "<br>";
 echo $huruf[5];
 echo "<br>"; 
...
<!-- Menampilkan isi array multi dimensi dengan perulangan foreach-->
