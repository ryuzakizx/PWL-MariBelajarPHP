...
;
// 2. Cara Baru
	$bulan = ["Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Nopember", "Desember"];
...
// //Menampilkan array dengan var_dump() atau print_r()
	...
	var_dump($hari);
	echo "<h4>Hasil tampilan array bernama bulan menggunakan
	print_r() adalah :</h4>";
	print_r($bulan);
...
pada array yaitu "foreach"-->
	...
	<h3>Menampilkan Elemen Array Untuk Keperluan
Pengguna</h3>

	<?php
	$angka = [3,2,15,20,11,'STMIK',89,99,100,109,200,209,];
	?>
	...
	<!-- Pengulangan menggunakan Foreach dan template tanda
	{} diganti dengan : dan endforeach-->
